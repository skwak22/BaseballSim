public class Games {
    ...
    public void simulateGame() {
        ...
        System.out.println(SP1.K+ " Strikeouts for "+SP1.name);
        if (Score[0] > Score[1]) System.out.println(team1.name+" wins over "+team2.name+" with a score of "+Score[0]+" to "+Score[1]+".");
        else System.out.println(team2.name+" wins over "+team1.name+" with a score of "+Score[1]+" to "+Score[0]+".");
    }
